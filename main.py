...
class Bot:
    def __init__(self):
        ...
        # motors
        self.driveMotors = [Motor(Ports.PORT1, False), Motor(Ports.PORT6, False)]
        self.cannonRotateMotor = Motor(Ports.PORT4, False) # other one will be the  car
        self.cannonMotors = [Motor(Ports.PORT2, False), Motor(Ports.PORT3, False)]
